...
module.exports = {
  token: {
    JWT_SECRET_KEY: '4cc3sst0k3n',
    JWT_EXPIRES_IN: '900000',
    RJWT_SECRET_KEY: 'r3fr3sht0k3n',
    RJWT_EXPIRES_IN: '3d',
    OTP_JWT_SECRET_KEY: '0tpt0k3n',
    OTP_JWT_EXPIRES_IN: '300000',
  },
  mail: {
    SESSION_USER: 'phuongthanhlong.99',
    SESSION_PASS: 'ptlong2509',
  },
  datastore: {
    MONGO_URL:
      'mongodb://longpt99:ptlong2509@cluster0-shard-00-00.qcw5e.gcp.mongodb.net:27017,cluster0-shard-00-01.qcw5e.gcp.mongodb.net:27017,cluster0-shard-00-02.qcw5e.gcp.mongodb.net:27017/pay-app?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority',
  },
  /**************************************************************************
   *                                                                         *
  ...
  sockets: {
     ...
     *                                                                          *
     ***************************************************************************/
    onlyAllowOrigins: ['https://banas-pay-longpt99.netlify.app'],
    /***************************************************************************
     *                                                                          *
